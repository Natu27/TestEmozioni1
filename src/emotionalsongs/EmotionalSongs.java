...
/**
 * La classe {@code EmotionalSongs} permette di eseguire il programma attraverso la ricerca di brani musicali
 * e una funzione di registrazione che permette all'utente di creare playlist e valutare i brani in esse contenuti
 */
...
public class EmotionalSongs {
    ...
    /**
     * Permette alla Java Virtual Machine (JVM) di compilare ed eseguire il programma,
     * opportunamente creato con specifici comandi di selezione numerica e
     * controlli effettuati sulle diverse funzioni implementate nell'applicazione
     * @param args un oggetto di tipo {@code String[]}
     * @throws IOException
